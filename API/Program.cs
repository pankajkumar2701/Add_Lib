...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Add_Lib", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Add_LibContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Add_Lib API v1");
