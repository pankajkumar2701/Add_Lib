...
namespace Add_Lib.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class Add_LibContext : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-GFUVFUP;Initial Catalog=T238325_Add_Lib;Persist Security Info=True;user id=pankazz;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
